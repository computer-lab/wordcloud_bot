      ...
      for h in hashtags:
        ...
        if 'wordcloud' in ht:
          ...
          if sender == 'computerlab_':
            msg = '@'+user+', look at the '+msg_text+' wordcloud from your tweets that we generated for you!'
          elif user != sender:
            msg = '@'+user+', look at the '+msg_text+' wordcloud from your tweets that @'+sender+' generated for you!'
          else:
